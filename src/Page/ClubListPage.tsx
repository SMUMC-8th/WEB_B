...
//                     {/* 카드 리스트 */}
//                     <div className="flex-1 px-5 md:px-[20px] py-5">
//                         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-[20px]">
...
const ClubListPage = () => {
    return (
        <>
            <div className="w-full overflow-x-hidden px-5 md:px-[20px] py-[20px]">
                <SearchBar categoryTitle="카테고리" />
