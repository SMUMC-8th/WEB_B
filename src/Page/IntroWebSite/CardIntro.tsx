...
const CardIntro: React.FC<CardIntroProps> = ({ isOpen, onClose, type }) => {
  ...
  const content = {
    club: {
      title: "동아리 소개",
      description: "상명대학교의 다양한 중앙 동아리를 카테고리별로 탐색해보세요.<br/>학술, 예술, 종교 등 다양한 분야의 동아리 정보를 확인할 수 있습니다."
    },
    matching: {
      title: "동아리 매칭",
      description: "관심사와 희망 활동을 입력하면 당신에게 맞는 동아리를 추천해드립니다.<br/>새로운 경험과 친구를 만날 수 있는 기회를 놓치지 마세요!"
    },
    help: {
      title: "도움말",
      description: "SMUclub 이용 방법에 대한 자세한 안내를 제공합니다.<br/>자주 묻는 질문과 공지사항을 통해 궁금한 점을 해결하세요."
    }
  };
